  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <polyline points="9 4 3 8 9 12" />
        <polyline points="15 12 21 16 15 20" />
      </svg>
    ),
  },
  {
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
          ...
          {NAV.map(({ to, label, icon }) => (
            <NavLink
              ...
              style={({ isActive }) => ({
                ...
                boxShadow: isActive
                  ? "0 3px 10px rgba(var(--primary-rgb),0.3)"
                  : "none",
              })}
            >
              {icon}
      ...
      <main
        ...
        style={
          fullHeight
            ? S.mainFull
            : { ...S.main, overflowY: "auto", flex: 1 }
        }
      >
        {fullHeight ? children : <div style={S.content}>{children}</div>}
      </main>
    </div>
  );
}